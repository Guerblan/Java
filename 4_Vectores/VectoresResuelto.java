...
class VectoresResuelto {
    ...
    public static void ejercicio9() {
         ...
         * que use el método random,al igual que en Scanner uso la instancia
         * aquí tmb
         */
        Random random = new Random();
        for (int i = 0; i < array.length; i++) {
             ...
             * a una generación de números aleatorios entre 1-50,así es
             * como se escribiría
             */
        }
        for (int i = 0; i < array.length; i++) {
    ...
    public static void ejercicio18() {
        ...
        /**
         * aquí simplemento cambio a true el valor del booleano si está en
         * el array.Sólo
         * eso
         */
        for (int i = 0; i < numeros.length; i++) {
        ...
        /*
         * Para mejor impresión.En este condicional antes lo puse dentro del for
         * pero
    ...
    public static void ejercicio27() {
        ...
        /*
         * Aquí no es buena práctica inicializar en esos valores.Es mucho
         * más seguro
         * iniciar con el primer elemento del array
         * y comparar todos con ese,así servirá para culquiera que sean
         * los valores del
         ...
         */
        /*
         * Si igualo los valores másximo y mínimo al valor de la primera
         * posición del
         * array
         * ya sólo tendré que comparar valores con respecto a ese
    ...
    public static void ejercicio30() {
        ...
        /*
         * aquí tengo que poner un salto de línea así,no sé
         * muy bien porque pero
         * se imprimiría mal si no lo hago
         */
        teclado.nextLine();
        /*
         * Le doy al valor del array la variable longitud y listo,así es como
         * pido por
         * teclado
         * la longitud
         */
    ...
    public static void ejercicio53() {
        ...
        /*
         * Así es como se imprime un array,primero importo la clase
         * java.util.Arrays
    ...
    public static void ejercicio56() {
         ...
         * vemos que le damos a posición de i el valor de posición de i +
         * 1
         * por lo que si estamos en la última posición no hay una
         * posición i + 1
         */
        ...
        /*
         * Aquí,como arriba hemos corrido una posición a la izquierda en
         * todas las
         * posiciones
        ...
        System.out.println(
                "\033[31mEl array tras eliminar los valores 7 quedaría: \033[0m" + Arrays.toString(numeros));
    }
    ...
    public static void ejercicio63() {
        ...
        for (int i = 0; i < matriz.length; i++) {
            ...
            /*
             * importante aquí abajo que imprimamos el salto de línea fuera
             * del for interno
             * pero dentro
             * del for externo
             */
    ...
    public static void ejercicio65() {
        ...
        /*
         * aquí sólo usamos un for porque el usuario elige una fila
         * así que nos ahorra
    ...
    public static void ejercicio66() {
        ...
        for (int i = 0; i < numeros.length; i++) {
            for (int j = 0; j < numeros[i].length; j++) {
                ...
                /*
                 * Aquí abajo dentro del paréntesis ponemos 90 porque así
                 * imprimimos números del
                 * 0-90
    ...
    public static void ejercicio68() {
        ...
        for (int i = 0; i < numeros.length; i++) {
            for (int j = 0; j < numeros[i].length; j++) {
                /*
                 * Aquí en el paréntesis indico el rango del que sacaré el
                 * Random,
    ...
    public static void ejercicio69() {
        ...
        /*
         * Hago un do while para que el usuario esté obligado a meter una fila
         * que esté
         * entre 1 y 4
         */
        do {
        ...
        /*
         * En este for recorro sólo las coulmnas de la fila que voy a mostrar por
         * eso es
         * de "j" y hasta
