...
public interface InterfazFabrica {
    ...
    /**
     * Busca un robot y cambia su estado a trabajando si no lo está, o a no
     * trabajando si lo está.
     * 
     * @param identificador El identificador del robot
     */
     ...
     * con todos los robots obreros de la fábrica que estén trabajando, devolviendo
     * una lista de grupos de robots
     * Cada grupo de robot debe estar ordenado por identificador. La estructura
     * seleccionada
     * para los grupos debe permitir comprobar si los robots están presentes en el
     * grupo
     * de manera eficiente
     * 
     * Nota: puedes crear una lista auxiliar a partir de otra coleccion en caso de
     * que lo necesites
