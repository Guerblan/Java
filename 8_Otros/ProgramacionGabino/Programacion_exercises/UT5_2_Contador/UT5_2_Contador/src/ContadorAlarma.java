...
/* Implementa una clase ContadorConAlarma, que lanza una alerta (por ejemplo, imprime un mensaje) al alcanzar el valor mínimo o máximo. */
...
public class ContadorAlarma {
    ...
    // menu
    public static void menu(ContadorAlarma object) {
        int option;
        boolean flag = true;
        while (flag) {
            ...
            }else if (object.value == object.max) {
