/* Ejercicio: Diseña tu propia clase Contador
En este ejercicio, desarrollarás una clase que representará un contador con diversas propiedades y funcionalidades. La idea es explorar conceptos básicos y avanzados de la programación orientada a objetos (POO). */
...
public class Contador {
    ...
    public void incrementar() {
        ...
        if ((value + step) <= max) {
            ...
            historial += ("\nAction " + contador + "- Valor " + value + " + " + step + " = " + max + "(Max)");
            value = max;
        }
    ...
    public void decrementar() {
        ...
        if ((value - step) >= min) {
            ...
            historial += ("\nAction " + contador + "- Valor " + value + " - " + step + " = " + min + "(Min)");
            value = min;
        }
    }
    ...
    // menu
    public static void menu(Contador object) {
        int option;
        boolean flag = true;
        while (flag) {
