...
class Bucles {
    ...
    public static void ejercicio5() {
        /*
         * Pide un número entero positivo y muestra todos los números comprendidos
    ...
    public static void ejercicio6() {
        /*
         * Pide un número entero positivo y muestra una cuenta atrás desde ese número
         * hasta 0.
         */
    }
    ...
    public static void ejercicio10() {
        /*
         * Pide dos números enteros y muestra todos los números comprendidos entre
         * ambos, incluidos los extremos, independientemente del orden introducido.
         */
    }
    ...
    public static void ejercicio13() {
        /*
         * Muestra las tablas de multiplicar del 1 al 10 completas, utilizando dos
         * bucles anidados.
         */
    }
    ...
    public static void ejercicio14() {
        /*
         * Pide una base y un exponente entero no negativo y calcula la potencia usando
         * un bucle, sin utilizar Math.pow().
         */
    }
    ...
    public static void ejercicio29() {
        /*
         * Pide un número entero y calcula cuántas cifras tiene. Considera que el número
         * 0 tiene una cifra.
         */
    }
    ...
    public static void ejercicio30() {
        /*
         * Pide un número entero positivo y calcula la suma de todas sus cifras.
         * Por ejemplo, para 472 el resultado será 13.
         */
    }

    public static void ejercicio31() {
        /*
         * Pide un número entero y muestra sus cifras en orden inverso. Por ejemplo,
         * si se introduce 1234, debe mostrar 4321.
         */
    }

    public static void ejercicio32() {
        /*
         * Pide un número entero positivo e indica si es capicúa, es decir, si se lee
    ...
    public static void ejercicio35() {
        /*
         * Pide un número entero positivo y muestra todos sus divisores, indicando
         * también cuántos divisores tiene.
         */
    }
    ...
    public static void ejercicio38() {
        /*
         * Pide dos límites enteros y muestra todos los números primos comprendidos
         * entre ellos.
         */
    }
    ...
    public static void ejercicio40() {
        /*
         * Muestra todos los números perfectos comprendidos entre 1 y 10000. Un número
    ...
    public static void ejercicio42() {
        /*
         * Pide dos números enteros positivos y calcula su máximo común divisor mediante
    ...
    public static void ejercicio43() {
        /*
         * Pide dos números enteros positivos y calcula su mínimo común múltiplo.
         */
    }
    ...
    public static void ejercicio45() {
        /*
         * Pide un número entero positivo e indica si es un número Armstrong. Un número
         * Armstrong es igual a la suma de sus cifras elevadas al número de cifras.
         */
    }

    public static void ejercicio46() {
        /*
         * Pide un número entero positivo en base decimal y muestra su representación
         * en binario sin utilizar métodos de conversión incorporados de Java.
         */
    }
    ...
    public static void ejercicio52() {
        /*
         * Pide la altura de un triángulo y dibuja una pirámide centrada con asteriscos.
         * Valida que la altura introducida sea positiva.
         */
    }
    ...
    public static void ejercicio55() {
        /*
         * Genera un número aleatorio entre 1 y 100 y permite al usuario intentar
         * adivinarlo. Indica en cada intento si el número secreto es mayor o menor y
         * muestra el número total de intentos al acertar.
         */
    }
    ...
    public static void ejercicio60() {
        /*
         * Crea un menú que permita introducir números hasta elegir la opción de salir.
         * Al terminar, muestra la cantidad de números introducidos, su suma, su media,
         * el mayor y el menor.
         */
    }
    ...
    public static void ejercicio63() throws InterruptedException {
        /*
         * Ejercicio 63:
