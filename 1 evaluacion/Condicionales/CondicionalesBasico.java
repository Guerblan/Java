...
class CondicionalesBasico {
    ...
    public static void ejercicio3() {
        ...
        if (numH >= 0 && numH < 24 && numM >= 0 && numM <= 59 && numS >= 00 && numS <= 59) {
    ...
    public static void recuperacion1() {
        /*
         * Recuperacion: pedir un numero entero y decir si es positivo, negativo o 0.
         */
        Scanner teclado = new Scanner(System.in);
        int num = 0;
    ...
    public static void recuperacion2() {
        /*
         * Recuperacion: pedir la edad y comprobar si el usuario es mayor o menor de
         * edad.
         */
        Scanner teclado = new Scanner(System.in);
        int edad = 0;
