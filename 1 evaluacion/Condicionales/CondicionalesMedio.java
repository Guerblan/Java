...
class CondicionalesMedio {
    ...
    public static void recuperacion1() {
        /*
         * Recuperacion: clasificar una nota de 0 a 10 como Suspenso, Aprobado,
         * Notable o Sobresaliente.
         */
        Scanner sca = new Scanner(System.in);
        int nota = 0;
        System.out.println("Dame una nota del 0 al 10");
        nota = sca.nextInt();
        if (nota < 0 || nota > 10) {
            System.out.println("Nota introducida invalida");
        } else if (nota <= 4) {
...
class CondicionalesPracticaMedio {
    public static void ejercicio1() {
        /*
