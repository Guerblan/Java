...
class Vectores {
    ...
    public static void ejercicio2() {
        /* Copia un array de cinco valores y muestra la copia en orden ascendente y descendente. */
    }
    ...
    public static void ejercicio4() {
        /* Pide un array de diez elementos y muestra otro con los elementos en orden inverso. */
    }
    ...
    public static void ejercicio14() {
        /* Crea una matriz del tamano pedido y rellena con unos las posiciones interiores. */
    }
    ...
    public static void ejercicio18() {
             ...
             * Declara un array de enteros llamado numeros con un tamaÃƒÆ’Ã‚Â±o de 5 elementos.
             * 
    ...
    public static void ejercicio19() {
             ...
             * Declara un array de enteros llamado notas con un tamaÃƒÆ’Ã‚Â±o de 4 elementos.
             * 
    ...
    public static void ejercicio22() {
            /*
             * Declara un array de enteros llamado precios con un tamaÃƒÆ’Ã‚Â±o de 4 elementos.
             * 
    ...
    public static void ejercicio25() {
            /*
             * Escriba un programa que llene un array con nÃƒÆ’Ã‚Âºmeros del 1 al 10 y los muestre
             * por
             * pantalla.
             */
            int[] array = new int[5];
    ...
    public static void ejercicio26() {
             ...
             * que use el mÃƒÆ’Ã‚Â©todo random,al igual que en Scanner uso la instancia aquÃƒÆ’Ã‚Â­ tmb
             */
            Random random = new Random();
            for (int i = 0; i < array.length; i++) {
                 ...
                 * a una generaciÃƒÆ’Ã‚Â³n de nÃƒÆ’Ã‚Âºmeros aleatorios entre 1-50,asÃƒÆ’Ã‚Â­ es como se escribirÃƒÆ’Ã‚Â­a
                 */
            }
            for (int i = 0; i < array.length; i++) {
                System.out.print(array[i] + ",");
    ...
    public static void ejercicio27() {
             ...
             * Declara un array de enteros llamado valores con un tamaÃƒÆ’Ã‚Â±o de 5 elementos.
             * 
    ...
    public static void ejercicio28() {
             ...
             * Declara un array de enteros llamado numeros con un tamaÃƒÆ’Ã‚Â±o de 6 elementos.
             * 
    ...
    public static void ejercicio29() {
             ...
             * 
             * Usa un bucle for para buscar si el nÃƒÆ’Ã‚Âºmero ingresado por el usuario estÃƒÆ’Ã‚Â¡ en el
             * array.
             * 
            ...
            /**
             * aquÃƒÆ’Ã‚Â­ simplemento cambio a true el valor del booleano si estÃƒÆ’Ã‚Â¡ en el array.SÃƒÆ’Ã‚Â³lo
             * eso
             */
            for (int i = 0; i < numeros.length; i++) {
                if (num == numeros[i]) {
            ...
            /*
             * Para mejor impresiÃƒÆ’Ã‚Â³n.En este condicional antes lo puse dentro del for pero
    ...
    public static void ejercicio30() {
             ...
             * Declara un array de enteros llamado edades con un tamaÃƒÆ’Ã‚Â±o de 5 elementos.
             * 
             * Inicializa el array con los valores 18, 22, 25, 30, 35.
             * 
             * Pide al usuario que ingrese una edad (puedes usar Scanner para esto).
             * 
             * Usa un bucle for para buscar si la edad ingresada por el usuario estÃƒÆ’Ã‚Â¡ en el
             * array.
             * 
    ...
    public static void ejercicio31() {
             ...
             * Declara un array de enteros llamado precios con un tamaÃƒÆ’Ã‚Â±o de 6 elementos.
             * 
             ...
             * 
             * Usa un bucle for para buscar si el precio ingresado por el usuario estÃƒÆ’Ã‚Â¡ en el
             * array.
             * 
             * Si el precio estÃƒÆ’Ã‚Â¡ en el array, imprime un mensaje diciendo: "El precio X estÃƒÆ’Ã‚Â¡
             * en el array".
             * 
             * Si el precio no estÃƒÆ’Ã‚Â¡ en el array, imprime un mensaje diciendo: "El precio X
    ...
    public static void ejercicio32() {
             ...
             * 
             * Usa un bucle for para buscar si la temperatura ingresada por el usuario estÃƒÆ’Ã‚Â¡
             * en el array.
             * 
             ...
             * 
             * Si la temperatura no estÃƒÆ’Ã‚Â¡ en el array, imprime un mensaje diciendo: "La
    ...
    public static void ejercicio33() {
             ...
             * Declara un array de enteros llamado edades con un tamaÃƒÆ’Ã‚Â±o de 6 elementos.
             * 
             ...
             * array.
             * 
             * Si la edad estÃƒÆ’Ã‚Â¡ en el array, imprime un mensaje diciendo: "La edad X estÃƒÆ’Ã‚Â¡ en
             * el array en la posiciÃƒÆ’Ã‚Â³n Y".
             * 
             * Si la edad no estÃƒÆ’Ã‚Â¡ en el array, imprime un mensaje diciendo: "La edad X no
    ...
    public static void ejercicio35() {
             ...
             * Declara un array de cadenas (String) llamado nombres con un tamaÃƒÆ’Ã‚Â±o de 5
             * elementos.
             * 
             ...
             * 
             * Usa un bucle for para buscar si el nombre ingresado por el usuario estÃƒÆ’Ã‚Â¡ en el
             * array.
             * 
    ...
    public static void ejercicio36() {
             ...
             * BUSCAR ELEMENTOS EN UN ARRAY
             * 
             * Declara un array de cadenas llamado nombres con un tamaÃƒÆ’Ã‚Â±o de 5 elementos.
             * 
             ...
             * Pide al usuario que ingrese un nombre (puedes usar Scanner para esto).
             * 
             * Usa un bucle for para verificar si el nombre ingresado por el usuario estÃƒÆ’Ã‚Â¡ en
             * el array.
             * 
             * Si el nombre estÃƒÆ’Ã‚Â¡ en el array, imprime un mensaje diciendo:
            ...
            for (int i = 0; i < nombres.length; i++) {
                if (nombre.equals(nombres[i])) {
                    encontrado = true;/*
                                       * Este booleano lo uso para poder imprimir en una sola linea la soluciÃƒÆ’Ã‚Â³n.
    ...
    public static void ejercicio37() {
             ...
             * Declara un array de enteros llamado numeros con un tamaÃƒÆ’Ã‚Â±o de 7 elementos.
             * 
            ...
            /*
             * AquÃƒÆ’Ã‚Â­ no es buena prÃƒÆ’Ã‚Â¡ctica inicializar en esos valores.Es mucho mÃƒÆ’Ã‚Â¡s seguro
             * iniciar con el primer elemento del array
             * y comparar todos con ese,asÃƒÆ’Ã‚Â­ servirÃƒÆ’Ã‚Â¡ para culquiera que sean los valores del
             ...
             */
            /*
             * Si igualo los valores mÃƒÆ’Ã‚Â¡sximo y mÃƒÆ’Ã‚Â­nimo al valor de la primera posiciÃƒÆ’Ã‚Â³n del
             * array
             * ya sÃƒÆ’Ã‚Â³lo tendrÃƒÆ’Ã‚Â© que comparar valores con respecto a ese valor.Mejor forma de
             * plantearlo
             */
    ...
    public static void ejercicio38() {
            /*
             * DescripciÃƒÆ’Ã‚Â³n:
             * Declara un array de enteros llamado numeros con un tamaÃƒÆ’Ã‚Â±o de 10 elementos.
             * InicialÃƒÆ’Ã‚Â­zalo con los valores {12, 5, 8, 21, 30, 17, 40, 3, 14, 27}.
             * Usa un bucle for para recorrer el array y contar cuÃƒÆ’Ã‚Â¡ntos nÃƒÆ’Ã‚Âºmeros son pares y
    ...
    public static void ejercicio39() {
            ...
            /*
             * aquÃƒÆ’Ã‚Â­ tengo que poner un salto de lÃƒÆ’Ã‚Â­nea asÃƒÆ’Ã‚Â­,no sÃƒÆ’Ã‚Â© muy bien porque pero
             * se imprimirÃƒÆ’Ã‚Â­a mal si no lo hago
             */
            teclado.nextLine();
            /*
             * Le doy al valor del array la variable longitud y listo,asÃƒÆ’Ã‚Â­ es como pido por
             * teclado
             * la longitud
             */
    ...
    public static void ejercicio42() {
             ...
             * Inicializa el array con los valores 30, 10, 50, 20, 40, 60.
             * 
             * Usa el algoritmo de ordenaciÃƒÆ’Ã‚Â³n por selecciÃƒÆ’Ã‚Â³n para ordenar el array de menor a
             * mayor.
             * 
             * Imprime el array ordenado.
             */
    ...
    public static void ejercicio43() {
             ...
             * DescripciÃƒÆ’Ã‚Â³n:
             * Escribe un programa en Java que implemente el mÃƒÆ’Ã‚Â©todo de burbuja para ordenar
             * un array de enteros en orden ascendente. El array inicial serÃƒÆ’Ã‚Â¡: {5, 3, 8, 4,
             * 6}.
             */
    ...
    public static void ejercicio44() {
             ...
             * DescripciÃƒÆ’Ã‚Â³n:
             * Ahora, escribe un programa en Java que implemente el mÃƒÆ’Ã‚Â©todo de burbuja para
    ...
    public static void ejercicio45() {
             ...
             * Escribe un programa en Java que use el mÃƒÆ’Ã‚Â©todo de burbuja para ordenar un
    ...
    public static void ejercicio46() {
             ...
             * 
             * Solicitar al usuario el tamaÃƒÆ’Ã‚Â±o de un array unidimensional de nÃƒÆ’Ã‚Âºmeros enteros.
             * 
             * Rellenar el array con valores introducidos por teclado.
             * 
             * Ordenar el array de mayor a menor utilizando el mÃƒÆ’Ã‚Â©todo de la burbuja (Bubble
             * Sort).
             * 
    ...
    public static void ejercicio47() {
             ...
             * 
             * Ordenar el array de menor a mayor utilizando el mÃƒÆ’Ã‚Â©todo de selecciÃƒÆ’Ã‚Â³n
             * (Selection Sort).
             * 
    ...
    public static void ejercicio50() {
             ...
             * 
             * Crea un programa en Java que genere una matriz de 2x2 con nÃƒÆ’Ã‚Âºmeros aleatorios
    ...
    public static void ejercicio51() {
             ...
             * llene con nÃƒÆ’Ã‚Âºmeros aleatorios entre 1 y 10. Luego, muestra toda la matriz en
            ...
            for (int i = 0; i < matriz.length; i++) {
                ...
                /*
                 * importante aquÃƒÆ’Ã‚Â­ abajo que imprimamos el salto de lÃƒÆ’Ã‚Â­nea fuera del for interno
                 * pero dentro
                 * del for externo
                 */
                System.out.println();
    ...
    public static void ejercicio52() {
            /*
             * Modifica el programa anterior para que, despuÃƒÆ’Ã‚Â©s de mostrar la matriz, pida al
             * usuario un nÃƒÆ’Ã‚Âºmero de fila (entre 1 y 3) y muestre solo los elementos de esa
             * fila.
             */
            int[][] matriz = new int[3][3];
            Random random = new Random();
            ...
            /*
             * aquÃƒÆ’Ã‚Â­ sÃƒÆ’Ã‚Â³lo usamos un for porque el usuario elige una fila asÃƒÆ’Ã‚Â­ que nos ahorra
    ...
    public static void ejercicio53() {
            ...
            for (int i = 0; i < numeros.length; i++) {
                for (int j = 0; j < numeros[i].length; j++) {
                    ...
                    /*
                     * AquÃƒÆ’Ã‚Â­ abajo dentro del parÃƒÆ’Ã‚Â©ntesis ponemos 90 porque asÃƒÆ’Ã‚Â­ imprimimos nÃƒÆ’Ã‚Âºmeros del
                     * 0-90
    ...
    public static void ejercicio54() {
            /*
             * Genere una matriz de 4 filas x 5 columnas con nÃƒÆ’Ã‚Âºmeros aleatorios entre 100 y
             * 999.
             * 
    ...
    public static void ejercicio55() {
            ...
            for (int i = 0; i < numeros.length; i++) {
                for (int j = 0; j < numeros[i].length; j++) {
                    /*
                     * AquÃƒÆ’Ã‚Â­ en el parÃƒÆ’Ã‚Â©ntesis indico el rango del que sacarÃƒÆ’Ã‚Â© el Random,
    ...
    public static void ejercicio56() {
             ...
             * 
             * Pida al usuario un nÃƒÆ’Ã‚Âºmero de fila (entre 1 y 4) y muestre los datos de esa
             * fila.
             * 
             * Valide que el nÃƒÆ’Ã‚Âºmero de fila estÃƒÆ’Ã‚Â© en el rango correcto (si el usuario ingresa
            ...
            /*
             * Hago un do while para que el usuario estÃƒÆ’Ã‚Â© obligado a meter una fila que estÃƒÆ’Ã‚Â©
             * entre 1 y 4
             */
            do {
            ...
            /*
             * En este for recorro sÃƒÆ’Ã‚Â³lo las coulmnas de la fila que voy a mostrar por eso es
             * de "j" y hasta
    ...
    public static void ejercicio58() {
             ...
             * Escriba un programa que almacene en un array 15 nÃƒÆ’Ã‚Âºmeros aleatorios double
    ...
    public static void ejercicio59() {
             ...
             * necesitas eliminar un estudiante por su nombre. La lista estÃƒÆ’Ã‚Â¡ implementada
             * como un array de tamaÃƒÆ’Ã‚Â±o fijo.
             * 
             * Implementa un mÃƒÆ’Ã‚Â©todo en Java llamado eliminarEstudiante(String nombre), que
    ...
    public static void ejercicio60() {
            ...
            /*
             * AsÃƒÆ’Ã‚Â­ es como se imprime un array,primero importo la clase java.util.Arrays
    ...
    public static void ejercicio61() {
             ...
             * 
             * Busca un nÃƒÆ’Ã‚Âºmero especÃƒÆ’Ã‚Â­fico introducido por el usuario y sustitÃƒÆ’Ã‚Âºyelo por un 0.
             * 
    ...
    public static void ejercicio63() {
             ...
             * 
             * Crea un array de tamaÃƒÆ’Ã‚Â±o 10 e inicialÃƒÆ’Ã‚Â­zalo con los siguientes valores:
             * [3, 7, 2, 5, 1, 7, 4, 9, 6, 2].
             * 
             * Eliminar elemento por posiciÃƒÆ’Ã‚Â³n:
             * 
             * Pide al usuario que ingrese una posiciÃƒÆ’Ã‚Â³n (ÃƒÆ’Ã‚Â­ndice) y elimina el elemento en
             ...
             * 
             * Elimina todos los nÃƒÆ’Ã‚Âºmeros 7 del array, desplazando los elementos restantes y
             * rellenando con 0 al final.
             * 
             ...
             * vemos que le damos a posiciÃƒÆ’Ã‚Â³n de i el valor de posiciÃƒÆ’Ã‚Â³n de i + 1
             * por lo que si estamos en la ÃƒÆ’Ã‚Âºltima posiciÃƒÆ’Ã‚Â³n no hay una posiciÃƒÆ’Ã‚Â³n i + 1
             */
            for (int i = index; i < numeros.length - 1; i++) {
                numeros[i] = numeros[i + 1];
            }
            /*
             * AquÃƒÆ’Ã‚Â­,como arriba hemos corrido una posiciÃƒÆ’Ã‚Â³n a la izquierda en todas las
             * posiciones
            ...
            System.out.println("\033[31mEl array tras eliminar los valores 7 quedarÃƒÆ’Ã‚Â­a: \033[0m" + Arrays.toString(numeros));
        }
